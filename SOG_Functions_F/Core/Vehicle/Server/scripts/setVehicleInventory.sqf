...
_sql_res = "extDB3" callExtension format["0:SQL:UPDATE vehicles SET vehicleInvItem = '%1', vehicleInvBackpack = '%2', vehicleInvMagazine = '%3', vehicleInvWeapon = '%4' WHERE id = '%5'", _vehItemCargo, _vehBachpackCargo, _vehMagazineCargo, _vehWeaponCargo, _vehicleUID];