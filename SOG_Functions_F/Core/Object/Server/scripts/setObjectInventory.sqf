...
_sql_res = "extDB3" callExtension format["0:SQL:UPDATE objects SET objInvItem = '%1', objInvBackpack = '%2', objInvMagazine = '%3', objInvWeapon = '%4' WHERE id = '%5'", _objItemCargo, _objBachpackCargo, _objMagazineCargo, _objWeaponCargo, _objUID];